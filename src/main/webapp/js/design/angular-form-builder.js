(function() {
  ...
  angular.module('builder.controller', ['builder.provider']).controller('fbFormObjectEditableController', [
    '$scope', '$injector', '$http', function($scope, $injector, $http) {
      var $builder;
      ...
      $scope.setupScope = function(formObject) {
        ...
        3. Watch scope.label, .hint, .required, .options then copy to origin formObject.
        ...
        if (formObject.component == 'checkbox' || formObject.component == 'radio' || formObject.component == 'selectbox' ){
            $scope.optionsText = formObject.options.join('\n');
        }
        $scope.$watch('[label, hint, required]', function() {	
          formObject.label = $scope.label;
          formObject.hint = $scope.hint;
          formObject.required = $scope.required;        
          return formObject.required = $scope.required;
        }, true);
        ...
        $scope.$watch('optionsText', function(text) {
        	 if (formObject.component == 'checkbox' || formObject.component == 'radio' || formObject.component == 'selectbox') {
                 ...
                 $scope.options = (function() {
                   ...
                   angular.forEach(_ref, function(comp) {
		          		var temp = comp.split(',');
		          		var _code  = (temp[0] != null) ? temp[0] : '';
		          		var _value = (temp[1] != null) ? temp[1] : _code;
		          		if (_value.length > 0) {
		          			var data = {};
		          			data.code = _code;
		          			data.value = _value;
	                        ...
	                        _optionsData.push(data);
	                     }
					});

                   formObject.optionsData = _optionsData;
                   return _results;
                 })();
        ...
        $scope.$watch('[options, optionSource]', function() {	
        	if (formObject.component == 'checkbox' || formObject.component == 'radio' || formObject.component == 'selectbox'){
	        	formObject.optionSource = $scope.optionSource;
	            if ($scope.optionSource == 'masterData') {
	          	    formObject.masterData = $scope.masterData;
	          	    $scope.options = [];
	          	    formObject.optionsData = [];
		          	angular.forEach($scope.masterData.content, function(comp) {
		          		$scope.options.push(comp.value);
					});
	          	  if (formObject.component == 'selectbox') {
	          		$scope.inputText = $scope.options[0];
	          	  }
	            }
	            if ($scope.optionSource == 'options') {
	          	  formObject.masterData = {};	 
	          	  $scope.options = (function() {
	          		  	var text = $scope.optionsText;
	          		  	var _i, _len, _ref, _results, _optionsData;
	                    _ref = text.split('\n');
	                    _results = [];
	                    _optionsData = [];
        ...
        $scope.$watch('masterData', function() {
        	if (formObject.component == 'checkbox' || formObject.component == 'radio' || formObject.component == 'selectbox'){
        		formObject.masterData = $scope.masterData;
        ...
        $scope.$watch('[negativeNumberAllowed, allowDecimal]', function() {
        	if (formObject.component == 'numericField'){
        		formObject.negativeNumberAllowed = $scope.negativeNumberAllowed;
        		return formObject.allowDecimal = $scope.allowDecimal;
            }
          }, true);
        
        
        $scope.$watch('capitalization', function() {
        	if (formObject.component == 'textField' || formObject.component == 'multilineTextfield') {
            	return formObject.capitalization = $scope.capitalization;
        	}
          }, true);
        
        $scope.$watch('autoCorrect', function() {
        	if (formObject.component == 'textField' || formObject.component == 'multilineTextfield') {
        		return formObject.autoCorrect = $scope.autoCorrect;
        	}
          }, true);
        
        
        $scope.$watch('[autoLinkWebEmailAddress, autoLinkPhoneNumber]', function() {	
            if (formObject.component == 'label') {                
                formObject.autoLinkWebEmailAddress = $scope.autoLinkWebEmailAddress;
                return formObject.autoLinkPhoneNumber = $scope.autoLinkPhoneNumber;
            }
          }, true);
        
        $scope.$watch('[dateMode, minimumDate, maximumDate]', function() {	
            if (formObject.component == 'datePicker') {
            	formObject.dateMode = $scope.dateMode;
                formObject.minimumDate = $scope.minimumDate;
                return formObject.maximumDate = $scope.maximumDate;
            }
          }, true);
        
        $scope.$watch('color', function() {	
            if (formObject.component == 'label') {
                return formObject.color = $scope.color;
            }
          }, true);
        
        
        $scope.$watch('textColor', function() {	
        	if (formObject.component == 'label') {
        		return formObject.textColor = $scope.textColor;
        	}
        }, true);

        $scope.$watch('colorOption', function() {
        	if (formObject.component == 'label') {
        		formObject.colorOption = $scope.colorOption;
        		if (formObject.colorOption == 'transparent') {
        			formObject.color = 'transparent';
        			$scope.color = 'transparent';
        		}
        		return formObject.color;
        	}
          }, true);
        
        $scope.$watch('lines', function() {	
        	if (formObject.component == 'multilineTextfield') {
        		if ($scope.lines == null || angular.isUndefined($scope.lines)) {
        			$scope.lines = 5;
        		}
        		
        		return formObject.lines = $scope.lines;
        	}
        }, true);
        
        $scope.$watch('[minimumAccuracy, enforceGPS, allowSubmissionIfNotAcquired]', function() {	
            if (formObject.component == 'currentLocation') {
                formObject.minimumAccuracy = $scope.minimumAccuracy;
                formObject.enforceGPS = $scope.enforceGPS;
                return formObject.allowSubmissionIfNotAcquired = $scope.allowSubmissionIfNotAcquired;
            }
          }, true);
        
        $scope.$watch('numberOfPhoto', function() {
        	if (formObject.component == 'photoAttachment') {
        		if ($scope.numberOfPhoto == null || angular.isUndefined($scope.numberOfPhoto)) {
        			$scope.numberOfPhoto = 1;
        		}
        		return formObject.numberOfPhoto = $scope.numberOfPhoto;
        	}
          }, true);
        
        $scope.$watch('products', function() {
        	if (formObject.component == 'product') {
        		return formObject.products = $scope.products;
        	}
          }, true);
        
        $scope.$watch('promotions', function() {
        	if (formObject.component == 'promo') {
        		return formObject.promotions = $scope.promotions;
        	}
          }, true);
        
        $scope.$watch('events', function() {
        	if (formObject.component == 'event') {
        		return formObject.events = $scope.events;
        	}
          }, true);
        
        $scope.$watch('installments', function() {
        	if (formObject.component == 'installment') {
        		return formObject.installments = $scope.installments;
        	}
          }, true);
        
        component = $builder.components[formObject.component];
        
        $scope.sourceTextColor = component.sourceTextColor;
        $scope.capitalizationOptions = component.capitalizationOptions;
        
        $scope.colorOptions = component.colorOptions;
        
        $scope.sourceOptions = component.sourceOptions;
        $scope.sourcesMode = component.sourcesMode;
        
        $scope.masterDataFactory = [];
		$http.get(_contextPath+'/web/masterdata/getMDRest').
	        success(function(data) {
	        	$scope.masterDataFactory = data;
				$scope.masterDataOptions = $scope.masterDataFactory;

        });
		
		$http.get(_contextPath+'/web/product/getProductRest').
        success(function(data) {
			$scope.products = data;
			//formObject.products = $scope.products;
        });

		$http.get(_contextPath+'/web/promo/getPromoRest').
        success(function(data) {
			$scope.promotions = data;
			//formObject.promotions = $scope.promotions;
        });
		
		$http.get(_contextPath+'/web/event/getEventRest').
        success(function(data) {
			$scope.events = data;
			//formObject.events = $scope.events;
        });
		
		$http.get(_contextPath+'/web/product/getInstallmentRest').
        success(function(data) {
      ...
      return $scope.data = {
        ...
        rollback: function() {
          ...
          $scope.hint = this.model.hint;
          $scope.optionsText = this.model.optionsText;
          
          return $scope.required = this.model.required;
        }
      };
    }
...
/*
    ...
    formObject:
        ...
        User can custom the label, hint, required and validation of the input.
    form:
...
(function() {
  ...
  angular.module('builder.provider', []).provider('$builder', function() {
    var $http, $injector, $templateCache, $scope;
    $injector = null;
    $http = null;
    $templateCache = null;
    this.config = {
    ...
    this.convertComponent = function(name, component) {
      var result, _ref, _ref1, _ref2, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      //textfield
      var _autocorrect, _capitalization, _capitalizationOptions, _colorOptions, _colorOption;
      //choices
      var _optionSource, _sourceOptions, _masterData, _masterDataOptions;
      //label
      var _autoLinkWebEmailAddress, _color, _autoLinkPhoneNumber, _textColor;
      //location
      var _allowSubmissionIfNotAcquired, _minimumAccuracy, _enforceGPS;
      //photo
      var _numberOfPhoto;
      //numeric
      var  _negativeNumberAllowed, _allowDecimal;
      //optionsdata
      var _optionsData;
      //date picker
      var _sourcesMode, _minimumDate, _maximumDate, _dateMode;
      //text area
      var _lines;
      
      var _products, _promotions, _events, _installments;
            
      result = {
        name: name,
        group: (_ref = component.group) != null ? _ref : 'Default',
        label: (_ref1 = component.label) != null ? _ref1 : '',
        hint: (_ref2 = component.hint) != null ? _ref2 : '',
        ...
        //label
        color : (_color = component.color) != null ? _color : 'transparent',
        autoLinkWebEmailAddress : (_autoLinkWebEmailAddress = component.autoLinkWebEmailAddress) != null ? _autoLinkWebEmailAddress : false,
        autoLinkPhoneNumber : (_autoLinkPhoneNumber = component.autoLinkPhoneNumber) != null ? _autoLinkPhoneNumber : false,
        textColor : (_textColor = component.textColor ) != null ? _textColor : '#000000',
        colorOptions : (_colorOptions = component.colorOptions) != null ? _colorOptions : [],
        colorOption : (_colorOption = component.colorOption) != null ? _colorOption : 'transparent',
        		
        		
        //textField
        autoCorrect: (_autocorrect = component.autoCorrect) != null ? _autocorrect : false,
        capitalizationOptions: (_capitalizationOptions = component.capitalizationOptions) != null ? _capitalizationOptions : [],
        capitalization: (_capitalization = component.capitalization) != null ? _capitalization : {},
        		
        //choices
        options: (_ref8 = component.options) != null ? _ref8 : [],
        masterDataOptions: (_masterDataOptions = component.masterDataOptions) != null ? _masterDataOptions : [],
        masterData: (_masterData = component.masterData) != null ? _masterData : {},
        sourceOptions:  (_sourceOptions = component.sourceOptions) != null ? _sourceOptions : [],
        optionSource: (_optionSource = component.optionSource) != null ? _optionSource : {},
                
        //currentLocation
        minimumAccuracy : (_minimumAccuracy = component.minimumAccuracy) != null ? _minimumAccuracy : 100,
        enforceGPS : (_enforceGPS = component.enforceGPS) != null ? _enforceGPS : false,
        allowSubmissionIfNotAcquired : (_allowSubmissionIfNotAcquired = component.allowSubmissionIfNotAcquired) != null ? _allowSubmissionIfNotAcquired : false,
        		
        numberOfPhoto : (_numberOfPhoto = component.numberOfPhoto) != null ? _numberOfPhoto : 1,
        		
        //numeric field
        negativeNumberAllowed : (_negativeNumberAllowed = component.negativeNumberAllowed) != null ? _negativeNumberAllowed : false,
        allowDecimal : (_allowDecimal = component.allowDecimal) != null ? _allowDecimal : false,
        		
        //optionsData
        optionsData : (_optionsData = component.optionsData) != null ? _optionsData : [],
        //datepicker
        sourcesMode : (_sourcesMode = component.sourcesMode) != null ? _sourcesMode : [],
        dateMode : (_dateMode = component.dateMode) != null ? _dateMode : {},
        minimumDate : (_minimumDate = component.minimumDate) != null ? _minimumDate : '',
        maximumDate : (_maximumDate = component.maximumDate) != null ? _maximumDate : '',
        //text area
        lines : (_lines = component.lines) != null ? _lines : 5,
        //product
        products: (_products = component.products) != null ? _products : [],
        //promotions
        promotions: (_promotions = component.promotions) != null ? _promotions : [],
        //events
        events: (_events = component.events) != null ? _events : [],
        //installments
        installments: (_installments = component.installments) != null ? _installments : []
    ...
    this.convertFormObject = function(name, formObject) {
      var component, result, _ref, _ref1, _ref2, _ref3, _ref5, _ref6;
      //textfield
      var _autoCorrect, _capitalization;
      //choices
      var _optionSource, _masterData;
      //label
      var _autoLinkWebEmailAddress, _color, _autoLinkPhoneNumber, _textColor, _colorOption;
      //location
      var _allowSubmissionIfNotAcquired, _minimumAccuracy, _enforceGPS;
      //photo
      var _numberOfPhoto;
      ...
      var _optionsData;
      //date picker
      var _minimumDate, _maximumDate, _dateMode;
      //text area
      var _lines;
      //products
      var _products;
      ...
      result = {	  
        ...
        hint: (_ref3 = formObject.hint) != null ? _ref3 : component.hint,
        required: (_ref6 = formObject.required) != null ? _ref6 : component.required
      };
      if (result.component == 'textField' || result.component == 'phoneNumber' || result.component == 'emailAddress'  || result.component == 'multilineTextfield' 
    	  || result.component == 'webAddress' ) {
    	      	  
    	  if (result.component == 'textField' || result.component == 'multilineTextfield') {
    		  result.autoCorrect = (_autoCorrect = formObject.autoCorrect) != null ? _autoCorrect : component.autoCorrect;
    	  }
    	  
      }
      
      if (result.component == 'checkbox' || formObject.component == 'radio' || formObject.component == 'selectbox') {
    	  result.options = (_ref5 = formObject.options) != null ? _ref5 : component.options;
    	  result.masterData = (_masterData = formObject.masterData) != null ? _masterData : component.masterData;
    	  result.optionSource = (_optionSource = formObject.optionSource) != null ? _optionSource : component.optionSource;
    	  result.optionsData = (_optionsData = formObject.optionsData) != null ? _optionsData : component.optionsData;
      }
      
      if (result.component == 'label') {
    	  result.color = (_color = formObject.color) != null ? _color : '#ffffff';
    	  result.autoLinkWebEmailAddress = (_autoLinkWebEmailAddress = formObject.autoLinkWebEmailAddress) != null ? _autoLinkWebEmailAddress : false;
    	  result.autoLinkPhoneNumber = (_autoLinkPhoneNumber = formObject.autoLinkPhoneNumber) != null ? _autoLinkPhoneNumber : false;
    	  result.textColor = (_textColor = formObject.textColor ) != null ? _textColor : '#000000';
    	  result.colorOption = (_colorOption = formObject.colorOption) != null ? _colorOption : 'transparent';
      }
      
      if (result.component == 'currentLocation') {
    	  result.minimumAccuracy = (_minimumAccuracy = formObject.minimumAccuracy) != null ? _minimumAccuracy : 100;
      	  result.enforceGPS = (_enforceGPS = formObject.enforceGPS) != null ? _enforceGPS : false;
          result.allowSubmissionIfNotAcquired = (_allowSubmissionIfNotAcquired = formObject.allowSubmissionIfNotAcquired) != null ? _allowSubmissionIfNotAcquired : false;
      }
      
      if (result.component == 'photoAttachment') {
    	  result.numberOfPhoto = (_numberOfPhoto = formObject.numberOfPhoto) != null ? _numberOfPhoto : 1;
      }
      
      if (result.component == 'numericField') {
    	  result.negativeNumberAllowed = (_negativeNumberAllowed = component.negativeNumberAllowed) != null ? _negativeNumberAllowed : false;
    	  result.allowDecimal = (_allowDecimal = component.allowDecimal) != null ? _allowDecimal : false;
      }
      
      if (result.component == 'datePicker') {
    	  result.minimumDate = (_minimumDate = component.minimumDate) != null ? _minimumDate : '';
    	  result.maximumDate = (_maximumDate = component.maximumDate) != null ? _maximumDate : '';
    	  result.dateMode = (_dateMode = component.dateMode) != null ? _dateMode : {};
      }
      
      if (result.component == 'multilineTextfield') {
    	  result.lines = (_lines = component.lines) != null ? _lines : 5;
    	}
      
      if (result.component == 'product') {
    	  result.products = (_products = component.products) != null ? _products : [];
    	}
      
      if (result.component == 'promo') {
    	  result.promotions = (_promotions = component.promotions) != null ? _promotions : [];
    	}
      
      if (result.component == 'event') {
    	  result.events = (_events = component.events) != null ? _events : [];
    	}
      
      if (result.component == 'installment') {
    	  result.installments = (_installments = component.installments) != null ? _installments : [];
    	}
...
//        formObjects[index].id = formObjects[index].component+''+index;
    ...
    this.registerComponent = (function(_this) {
      return function(name, component) {
        ...
        @param component: The component object.
            ...
            hint: {string} The hint of the input.
    ...
    this.insertFormObject = (function(_this) {
      return function(name, index, formObject) {
        ...
        @param form: The form object.
            ...
            hint: {string} The form object hint.
        ...
        if(angular.isUndefined(formObject.id)){
        	formObject.id = new Date().getTime();
        }
