...
angular.module('ngCart', ['ngCart.directives'])
    ...
    .service('ngCart', ['$rootScope', 'ngCartItem', 'store', function ($rootScope, ngCartItem, store) {
        ...
        this.addItem = function (id, name, price, quantity, quantityMax, data) {
            ...
            if (typeof inCart === 'object'){
                ...
                console.log("after add : "+angular.toJson(newItem))
    ...
    .factory('ngCartItem', ['$rootScope', '$log', function ($rootScope, $log) {
        ...
        item.prototype.setQuantityMax = function(quantityMax){
            var quantityMaxInt = parseInt(quantityMax);
            if (quantityMaxInt % 1 === 0){
                this._quantityMax = quantityMaxInt;
                if (this._quantityMax < 1) this._quantityMax = 1;
...
angular.module('ngCart.directives', ['ngCart.fulfilment'])
    ...
    .directive('ngcartAddtocart', ['ngCart', function(ngCart){
        return {
            ...
            transclude: true,
            templateUrl: _contextPath+'/template/addtocart.html',
    ...
    .directive('ngcartCart', [function(){
        return {
            ...
            controller : 'CartController',
            scope: {},
            templateUrl: _contextPath+'/template/cart.html',
            link:function(scope, element, attrs){
    ...
    .directive('ngcartSummary', [function(){
        return {
            ...
            scope: {},
            transclude: true,
            templateUrl: _contextPath+'/template/summary.html'
        };
    }])
    ...
    .directive('ngcartCheckout', [function(){
        return {
            ...
            transclude: true,
            templateUrl: _contextPath+'/template/checkout.html'
        };
    }]);;
...
.service('ngCart.fulfilment.http', ['$http', '$window', 'ngCart', function($http, $window, ngCart){

        this.checkout = function(settings){
        	console.log("items :" + angular.toJson(ngCart.getCart().items));
        	var items = angular.toJson(ngCart.getCart().items)

			var data={};
			data.items = items;
			console.log(data)
			$http.post(_contextPath+'/web/cart/checkout', data).
