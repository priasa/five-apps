...
<div class="row white-bg">
	<div class="col-lg-12">
		<div class="wrapper wrapper-content">
			<h4>Tata Cara Penggunaan Web Service Data Kabupaten Berdasarkan Provinsi</h4>
			<div class="tabs-container">
				<ul class="nav nav-tabs">
					<li class="active"><a data-toggle="tab" href="#tab-url">URL</a></li>
							...
							<div class="ibox-content">
								<table id="dTable" class="table table-striped">
									...
									<tbody>
										<tr>
											<td>Format</td>
											<td><strong>{URL}</strong>/sip/rest/kabupaten/<strong>{TOKEN}</strong>/findByProvinsi?kode=?</td>
										</tr>
										<tr>
											<td>Contoh</td>
											<td><strong>http://192.168.90.65:8181/kemenkes</strong>/sip/rest/kabupaten/<strong>20baeff1-9717-4822-ae14-c3134bc4487e</strong>/findByProvinsi?kode=11</td>
										</tr>
										<tr>
											<td></td>
											<td><p>
										...
										<tr>
											<td></td>
											<td><img width="90%"
												src="${ pageContext.request.contextPath }/images/url_kabupaten.png" /></td>
										</tr>
									</tbody>
								</table>
							</div>
								...
								<table id="dTable" class="table table-striped">
									...
									<tbody>
										...
										<tr>
											<td></td>
											<td><img width="90%"
												src="${ pageContext.request.contextPath }/images/ct_kabupaten.png" /></td>
										</tr>
									</tbody>
								</table>
							</div>
