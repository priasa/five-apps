	...
	<form:form class="form-horizontal" commandName="proposalEntityDto"
		...
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				<fmt:message key="header.proposal.send" />
			</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<div class="form-control">
							<a
								href="${pageContext.request.contextPath}/web/proposal/document/${proposalEntityDto.id}">${proposalEntityDto.proposalFilename}</a>
						</div>
					</div>
				</div>
