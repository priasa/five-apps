...
<div class="wrapper wrapper-content animated fadeIn">
	<form:form class="form-horizontal" commandName="proposalEntityDto"
		method="POST"
		action="${pageContext.request.contextPath}/web/proposal/upload/${processId}/${activityId}"
		enctype="multipart/form-data">

		<div class="ibox float-e-margins">
			<div class="ibox-title">
				<fmt:message key="header.proposal.upload" />
			</div>
			<div class="ibox-content">
				...
				<div class="form-group <form:errors path="dueDate" cssClass="error">error</form:errors>">
					<label class="col-sm-2 col-sm-2 control-label" for="dueDate">
						<fmt:message key="general.dueDate" /> 
				...
				<div class="form-group <form:errors path="proposalFilename" cssClass="error">error</form:errors>">
					<label class="col-sm-2 col-sm-2 control-label"> <fmt:message key="general.document" />
					</label>
					<div class="col-sm-8">
						<input type="file" name="file">
						<form:errors path="proposalFilename" cssClass="help-block text-danger" />
					</div>
				</div>
