...
<div class="wrapper wrapper-content animated fadeIn">
	<form:form class="form-horizontal" commandName="proposalEntityDto"
		method="POST"
		action="${pageContext.request.contextPath}/web/proposal/disposisiEselon2/${processId}/${activityId}"
		enctype="multipart/form-data">

		<div class="ibox float-e-margins">
			<div class="ibox-title">
				<fmt:message key="header.proposal.disposisiEselon2" />
			</div>
			<div class="ibox-content">
				...
				<div
					...
					<div class="col-sm-8 form-control-label">
						<form:select path="unitEselon2" class="form-control">
							<form:options items="${ eselon2 }" itemLabel="name" itemValue="id" />
						</form:select>
					</div>
				</div>
				...
				<div
					class="form-group <form:errors path="approvalStatus" cssClass="error">error</form:errors>">
					<label class="col-sm-2 col-sm-2 control-label" for="approvalStatus">
						<fmt:message key="general.approvalStatus" />
					</label>
					<div class="col-sm-8 form-control-label">
						<form:select path="approvalStatus" class="form-control">
							<form:option value="terima">
								<fmt:message key='general.terima' />
							</form:option>
							<form:option value="revisi">
								<fmt:message key='general.revisi' />
							</form:option>
							<form:option value="tolak">
								<fmt:message key='general.tolak' />
							</form:option>
						</form:select>
						<form:errors path="approvalStatus"
