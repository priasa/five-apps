...
@Document(collection = "UKP2")
public class UKP2 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7707617178663319588L;
	...
	private List<UKP2Detail> detail = new ArrayList<UKP2Detail>();
	...
	public List<UKP2Detail> getDetail() {
		return detail;
	}

	public void setDetail(List<UKP2Detail> detail) {
		this.detail = detail;
	}
