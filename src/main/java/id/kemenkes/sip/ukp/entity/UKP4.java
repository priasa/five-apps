...
@Document(collection = "UKP4")
public class UKP4 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1297985612824384111L;
	...
	private List<UKP4Detail> detail = new ArrayList<UKP4Detail>();
	...
	public List<UKP4Detail> getDetail() {
		return detail;
	}

	public void setDetail(List<UKP4Detail> detail) {
		this.detail = detail;
	}
