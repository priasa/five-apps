...
@Document(collection = "UKP3")
public class UKP3 implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3699860049285851995L;
	...
	private List<UKP3Detail> detail = new ArrayList<UKP3Detail>();
	...
	public List<UKP3Detail> getDetail() {
		return detail;
	}

	public void setDetail(List<UKP3Detail> detail) {
		this.detail = detail;
	}
